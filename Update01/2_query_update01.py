#code to make query files for BLAST - each query in a separate file
...
#code to make separate file with number of query sequences & output as _query_counter.txt
