...
#function to output BLAST results into an array (for later use) and print BLAST results to the terminal
...
#function to calculate BLAST statistics: % alignments, # of genes with hits, Total # N of genes, & output as _stats_genes_found.txt
...
#function to output matched and unmatched genes and append it to _stats_genes_found.txt
